    ...
    <form class="form"  method="POST" action="{{ route('savePost') }}" enctype="multipart/form-data">
      ...
      <div class="form-row">
        ...
        <div class="form-item" id="blog_input">
          <div class="row">
            <input type="text" name="title" class="form-control" placeholder="insert Title" style="border-radius: 0px;height: 35px;border-bottom: 1px solid lightgray;border-top: 0px solid lightgray;border-right: 0px solid lightgray;border-left: 0px solid lightgray;width: 48%;margin-left: 2%;">
            ...
            @if(!$post_forum)
            <select class="form-control" name="forum_id" style="border-radius: 0px;height: 35px;border: 0px solid lightgray;width: 48%" required="">
          ...
          <div id="description">
            ...
            <div class="form-textarea">
              <textarea name="description" placeholder="Hi @if(Auth::user()){{Auth::user()->name}}@else Guest @endif! Share your post here..."></textarea>
            </div>
            <!-- /FORM TEXTAREA -->

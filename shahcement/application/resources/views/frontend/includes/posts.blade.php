...
<div class="widget-box no-padding">
  ...
  <div class="widget-box-status">
    ...
    <div class="widget-box-status-content">
      ...
      <p class="widget-box-status-text">{!! substr($posts->description, 0,200) !!}@if(strlen($posts->description)>200) <a href="{{route('get_post_data',['id'=>$posts->id])}}" style="color: tomato;">+more </a>@endif </p>
      <!-- /WIDGET BOX STATUS TEXT -->
      @if($count_image == 1)
